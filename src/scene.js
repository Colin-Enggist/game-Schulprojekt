...
export class Scene{
    ...
    displayEl(){
        ...
        this.ent[0].forEach(async(el)=>{await ui.draw(el.display);});
        this.ent[2].forEach(async(el)=>{await bg.draw(el.display);});
        this.ent[1].forEach(async(el)=>{await main.draw(el.display);}); 
    }
